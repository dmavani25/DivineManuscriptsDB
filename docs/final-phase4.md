...
- **[DONE]** Add authentication and authorization to ensure only admins can add/delete and everyone else has read-only access.
...
- **[DONE]** Add custom pages and views for different users: admin, faculty, students
